...
class GazeboLinkPose:
    ...
    def __init__(self, robot_name, link_name):
        ...
        self.pos_sub = rospy.Subscriber("/ekf_slam", Odometry, self.callbackpos)
...
if __name__ == '__main__':
    try:
        ...
        while not rospy.is_shutdown():
            ...
            gp.pose_pub.publish(gp.car_pos)
            gp.publish_tf()
            rate.sleep()
